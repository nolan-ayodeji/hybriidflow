...
class bottom3bar extends StatefulWidget {
  final ftext;
  final action;
  final saction;

  const bottom3bar({key, this.ftext, this.action, this.saction})
      : super(key: key);
  @override
  _bottom3barState createState() => _bottom3barState();
}

class _bottom3barState extends State<bottom3bar> {
                                        ...
                                        child: AnimatedContainer(
                                            ...
                                            decoration: BoxDecoration(
                                              ...
                                              borderRadius: BorderRadius.only(
                                                topLeft: cc2 == true ? Radius.circular(22) : Radius.circular(30),
                                                bottomLeft:cc2 == true ? Radius.circular(22) : Radius.circular(30),
